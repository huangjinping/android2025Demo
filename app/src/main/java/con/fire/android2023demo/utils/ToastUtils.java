...
public class ToastUtils extends Toast {
     ...
     * @return
     */
    public static Toast makeText(Context context, CharSequence text, int duration, int Color) {
     ...
     * @return 自定义背景 资源
     */
    public static Toast makeText(Context context, CharSequence text, int duration, Drawable drawable) {
        mToast = ToastUtils.makeText(context, text, duration);
     ...
     * @return 自定义带点击事件的布局
     */
    public static Toast makeText(Context context, CharSequence text, int duration, View view, OnClickListener onClickListener) {
    ...
    public static Toast i(Context context, CharSequence text, int duration) {
        return ToastUtils.makeText(context, text, duration, context.getResources().getDrawable(R.drawable.background_standard_black)); //   R.drawable.background_standard_green));
    }
    ...
    public static Toast e(Context context, CharSequence text, int duration) {
        return ToastUtils.makeText(context, text + "", duration, context.getResources().getDrawable(R.drawable.background_standard_red));
    }
    ...
    public static Toast d(Context context, CharSequence text, int duration) {
        return ToastUtils.makeText(context, text, duration, context.getResources().getDrawable(R.drawable.background_standard_blue));
    }
    ...
    public static Toast w(Context context, CharSequence text, int duration) {
        return ToastUtils.makeText(context, text, duration, context.getResources().getDrawable(R.drawable.background_standard_orange));
    }
